...
export type { LocationQuery, LocationQueryRaw, LocationQueryValue, LocationQueryValueRaw, } from './query';
...
export { routeLocationKey, routerViewLocationKey, routerKey, matchedRouteKey, viewDepthKey, } from './injectionSymbols';
export { START_LOCATION_NORMALIZED as START_LOCATION } from './types';
export type { _RouteLocationBase, MatcherLocationAsPath, LocationAsRelativeRaw, RouteQueryAndHash, RouteLocationRaw, RouteLocation, RouteLocationNormalized, RouteLocationNormalizedLoaded, RouteParams, RouteParamsRaw, RouteParamValue, RouteParamValueRaw, RouteLocationNamedRaw, RouteLocationPathRaw, RouteLocationMatched, RouteLocationOptions, RouteRecordRedirectOption, _RouteRecordBase, RouteMeta, RouteComponent, RouteRecordName, RouteRecordRaw, NavigationGuard, NavigationGuardNext, NavigationGuardWithThis, NavigationHookAfter, } from './types';
