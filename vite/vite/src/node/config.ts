...
// 返回解析后的 environment.optimizeDeps
...
export async function resolveConfig(
  ...
  // 将 默认的 environment 选项 合并到 配置文件 中定义的 environment 选项
  ...
  // 依次运行插件的 hooks.configEnvironment 队列
  ...
  // 依次运行插件的 hooks.configResolved 队列
  await Promise.all(
    resolved
      .getSortedPluginHooks("configResolved")
