...
export function glob(
  source: InputPattern,
  options: EntryObjectPredicate & OptionsInternal
...
export const convertPathToPattern = withPatternsInputAssert(
  utils.path.convertPathToPattern
);

export const posix = {
  escapePath: withPatternsInputAssert(utils.path.escapePosixPath),
  convertPathToPattern: withPatternsInputAssert(
    utils.path.convertPosixPathToPattern
  ),
};
...
export const win32 = {
  ...
  convertPathToPattern: withPatternsInputAssert(
    utils.path.convertWindowsPathToPattern
  ),
};
