...
const hook = new tapable.AsyncSeriesWaterfallHook(['name', 'age'], 'MyAsyncSeriesWaterfallHook')
...
// after:  Lee 20
// intercept tap first:  Lee
// intercept tap second:  Lee
// over:  Lee
  ...
  return new Promise((function (_resolve, _reject) {
    ...
    function _next0() {
      ...
      _promise1.then((function (_result1) {
        ...
        _interceptors[0].result(name);
        _interceptors[1].result(name);
        _resolve(name);
      }), function (_err1) {
